...
function Controls:init()
	...
	local shorthands = {
		...
		audio = 'command:graphic_eq:script-binding uosc/audio#audio>1?音频',
		['audio-device'] = 'command:speaker:script-binding uosc/audio-device?音频设备',
		video = 'command:theaters:script-binding uosc/video#video>1?视频',
		...
		['stream-quality'] = 'command:high_quality:script-binding uosc/stream-quality?流媒体质量',
		['open-file'] = 'command:file_open:script-binding uosc/open-file?打开文件',
		['items'] = 'command:list_alt:script-binding uosc/items?播放列表/文件',
		prev = 'command:arrow_back_ios:script-binding uosc/prev?上一个',
		next = 'command:arrow_forward_ios:script-binding uosc/next?下一个',
		first = 'command:first_page:script-binding uosc/first?第一个',
		last = 'command:last_page:script-binding uosc/last?最后一个',
		['loop-playlist'] = 'cycle:repeat:loop-playlist:no/inf!?循环播放',
